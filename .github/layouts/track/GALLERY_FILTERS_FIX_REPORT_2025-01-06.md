...
<ul class="isotope-filters">
  <li>
    <a class="isotope-filter h6 active" data-isotope-filter="*" href="#"
      >anamorphosis</a
    >
  </li>
  <li>
    <a class="isotope-filter h6" data-isotope-filter="0" href="#"
      >photorealism</a
    >
  </li>
  <li>
    <a class="isotope-filter h6" data-isotope-filter="1" href="#">surrealism</a>
  </li>
  <li>
    <a class="isotope-filter h6" data-isotope-filter="2" href="#"
      >hyperrealism</a
    >
  </li>
  <li>
    <a class="isotope-filter h6" data-isotope-filter="3" href="#"
      >abstract artworks</a
    >
  </li>
</ul>
...
```tsx
<Gallery variant="preview" limit={5} showFilters={true} showViewAll={true} />
```
