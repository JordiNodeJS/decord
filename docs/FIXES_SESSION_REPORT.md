...
.header__logoDark { opacity: 1; }
.header__logoLight { opacity: 0; position: absolute; }
.header--scrolled .header__logoDark { opacity: 0; }
.header--scrolled .header__logoLight { opacity: 1; }
```
